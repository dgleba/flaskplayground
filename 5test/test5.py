...
http://nullege.com/codes/show/src%40f%40l%40Flask-SQLAlchemy-1.0%40test_sqlalchemy.py/251/flask.ext.sqlalchemy.SQLAlchemy.MetaData.reflect/python
...
class BasicAppTestCase(unittest.TestCase)
    ...
    def test_basic_insert(self)
        ...
        rv = c.get('')
        self.assertEqual(rv.data, b'First Itemn2nd Item')
...
class CommitOnTeardownTestCase(unittest.TestCase)
    ...
    def setUp(self)
        ...
        @app.route('')
        def index()
            return 'n'.join(x.title for x in Todo.query.all())
