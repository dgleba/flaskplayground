...
class CarAdmin(sqla.ModelView):
    ...
    column_labels = dict(desc2='Description2_of_Car_________',desc5='Description5_of_Car__',)
    # Use CSS in this template to change the column header text of desc6...
    list_template = 'list.html'

    
# Create admin
admin = admin.Admin(app, name='Column width Trickery', template_mode='bootstrap3')
